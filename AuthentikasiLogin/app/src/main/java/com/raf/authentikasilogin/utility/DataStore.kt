package com.raf.authentikasilogin.utility
...
class DataStore @Inject constructor(@ApplicationContext private val context: Context) {
    ...
    private val userTokenStateKey = stringPreferencesKey("user_token_state_key")
    ...
    suspend fun setUserTokenState(value: String) {
        context.dataStore.edit { pref ->
            pref[userTokenStateKey] = value
        }
    }

    fun getUserTokenState(): Flow<String> = context.dataStore.data.map { pref ->
        pref[userTokenStateKey] ?: ""
    }
}